...
async function main() {
  ...
  const FairTokenGFTContract = await hre.ethers.getContractFactory("FairTokenGFT_V1");
  ...
  const ERC20TokenFactoryContract = await hre.ethers.getContractFactory("ERC20TokenFactory_V1");
